		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Diami test",
									"targetURL": "#besoapeoplediami-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"besoapeoplediami-display": {
								"semanticObject": "besoapeoplediami",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.soapeople.diami",
									"url": sap.ui.require.toUrl("be/soapeople/diami")
								}
							}
						}
					}
